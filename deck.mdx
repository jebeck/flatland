...
<ul>
  <Appear>
    <li>
      compute on the GPU in OffscreenCanvas in a Web Worker{" "}
...
<CodeSurfer code={require("!raw-loader!./assets/code/web-worker.js").default} />
...
# caching & invalidation in the React component lifecycle
