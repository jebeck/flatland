...
import { BobRoss, TSNEonMNIST, UMAPonMNIST } from "./examples.bundle.js"
...
>
  ...
  >
    <h2 style={{ margin: 0 }}>some MNIST ✍️ digits</h2>
  </div>
</div>
...
<div style={{ position: "fixed", bottom: "25rem", right: "27.5rem" }}>
  <h1 style={{ color: "#5DB968", fontStyle: "italic" }}>
    &nbsp;&nbsp;<span style={{ textDecoration: "underline" }}>compute</span>{" "}
    components!
  </h1>
</div>
...
- Webpack
  - worker-loader
  - workerize-loader
  - 😕 (no create-react-app support, yet)
...
<img src="./assets/img/OffscreenCanvas.png" style={{ maxHeight: "90vh" }} />

<Appear>

<img
  src="./assets/img/OffscreenCanvas-detail.png"
  style={{ left: "5vh", position: "absolute", top: "20vh" }}
/>
...
- 🤫 the secret is you always _store_ results in the cache
...
- Workers = good for dev
  - still a challenge! <span role='img' aria-label='laptop emoji'>💻</span> on <span role='img' aria-label='fire emoji'>🔥</span>
...
<img
  src="./assets/img/hedgehog.gif"
  style={{ left: "2rem", maxWidth: "300px", position: "absolute", top: "2rem" }}
/>
...
<Image src="./assets/img/bobross.jpg" />

---

<img src="./assets/img/bobross_data.png" style={{ maxHeight: "90vh" }} />
