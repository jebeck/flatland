...
import UMAPonMNISTExamples from './components/LoadableUMAPonMNISTExamples'
...
<UMAPonMNISTExamples data={data1000} iterate={true} worker={false} />
...
<UMAPonMNISTExamples data={data1000} iterate={true} />
...
<UMAPonMNISTExamples data={data2500} iterate={true} />
...
<UMAPonMNISTExamples data={data5000} iterate={true} />
