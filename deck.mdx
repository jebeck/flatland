...
import SphereVisitsFlatland, { startingCameraPosition } from "./components/SphereVisitsFlatland";
...
<Three camera={{fov:75, near: 0.1, far: 2000, position: startingCameraPosition }}>
