...
<Three>
  <ColorSpace
    ...
    orbitTarget={[0, 0, 25]}
    {...getRandomlyDistributedColors.hsl(2000)}
  />
</Three>
...
<Three>
  <ColorSpace
    cameraPosition={[90, 50, 75]}
    orbitTarget={[0, 0, 25]}
    {...getRandomlyDistributedColors.rgb(2000)}
  />
</Three>
...
<Three>
  <ColorSpace
    cameraPosition={[90, 50, 75]}
    orbitTarget={[0, 0, 25]}
    {...getRandomlyDistributedColors.lab(2000)}
  />
</Three>

---

<InteractiveColorSpace {...getRandomlyDistributedColors.lab(2000)} />
